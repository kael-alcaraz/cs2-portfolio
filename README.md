...
- [workshop-validator.py](q1/workshop-validator.py) and [input-validation.md](q1/input-validation.md)
- [secure_registration.py](q1/secure_registration.py) and [cybersecurity.md](q1/cybersecurity.md)
